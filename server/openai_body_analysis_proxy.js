          ...
          content: [
            {
              ...
              text: [
                ...
                '- Set face_visible false if you see only a body, clothing, wall, chair, poster, screen, printed photo, object, or a face-like pattern.',
                '- Set face_visible false if the face is cropped out, turned away, covered, too blurry, or too small to identify as a live person.',
                '- Set capture_accepted true only when a real live person face is visible and the person is visible enough to make an estimate.',
